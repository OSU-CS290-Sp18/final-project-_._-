...
function initMap() {
    ...
    var laxMarker = new google.maps.Marker({
        position: lax,
        map: map
    });
    ...
    var hnlMarker = new google.maps.Marker({
        position: hnl,
        map: map
    });
    ...
    var ewrMarker = new google.maps.Marker({
        position: ewr,
        map: map
    });
    ...
    var ordMarker = new google.maps.Marker({
        position: ord,
        map: map
    });
    ...
    var denMarker = new google.maps.Marker({
        position: den,
        map: map
    });
    ...
    var sanMarker = new google.maps.Marker({
        position: san,
        map: map
    });
    ...
    var pdxMarker = new google.maps.Marker({
        position: pdx,
        map: map
    });
